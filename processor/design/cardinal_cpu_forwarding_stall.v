...
// ============================================================
// Writeback value used by forwarding and register file writeback
// ============================================================
wire [0:63] wb_data;
...
// ============================================================
wire [0:63] branch_cmp_value_ex;
wire [0:63] branch_cmp_value_wb;
wire [0:63] branch_cmp_value;

assign branch_cmp_value_ex = ex_results;

assign branch_cmp_value_wb =
...
// for VSD, ID_EX_rA holds the (possibly forwarded) store data
